...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO MOAC", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WH7F9DNDRQtm9GTgrjxhRxtKPH8joctd9W")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WH7F9DNDRQtm9GTgrjxhRxtKPH8joctd9W"
	account := &openwallet.AssetsAccount{Alias: "MOAC", WalletID: walletID, Required: 1, Symbol: "MOAC", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WH7F9DNDRQtm9GTgrjxhRxtKPH8joctd9W"
	accountID := "G5pVUwPqheTuWvAjoXkg8VdJymqqm8suLX8vZ4DjzKGE"
