...
func (bs *MOACBlockScanner) RescanFailedRecord() {
	...
	list, err := bs.wm.Blockscanner.GetUnscanRecords()
	if err != nil {
...
func (bs *MOACBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
func (bs *MOACBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *MOACBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
//@optional
func (bs *MOACBlockScanner) SupportBlockchainDAI() bool {
	return true
}
