...
func (bs *MOACBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *MOACBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *MOACBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *MOACBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *MOACBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *MOACBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *MOACBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
